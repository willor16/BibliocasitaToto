    ...
    <div className="overflow-hidden">
      ...
      >
        <div className="container mx-auto px-4 py-4 flex justify-between items-center">
          <a href="#" className="text-2xl font-bold text-white">Bibliocasita</a>
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <motion.div
              ...
              className="bg-white rounded-lg shadow-lg overflow-hidden"
            >
              <Image src="/placeholder.svg?height=300&width=400" alt="Proyecto no lucrativo" width={400} height={300} className="w-full h-48 object-cover" />
              <div className="p-6">
      ...
      <footer className="bg-gray-900 text-white py-12">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div>
              <h3 className="text-2xl font-bold mb-4">BIBLIOCASITA TOTO</h3>
              <p className="mb-4">La información en esta página web se proporciona con el fin de brindar información precisa y actualizada, aunque no se garantiza la exactitud o integridad de la misma. No nos hacemos responsables por los daños y perjuicios derivados del mal uso de la página o sus contenidos.</p>
            </div>
            <div>
              <h3 className="text-2xl font-bold mb-4">V-WAD COMPANY</h3>
              <p className="mb-4">Importante: El uso de la página es con fines informativos. Se prohíbe el uso malicioso de la página.</p>
              <p className="mb-2">SERVICIOS: Web-móvil, Software IOS, WINDOWS, Hosting, Dominio</p>
            </div>
            <div>
              <h3 className="text-2xl font-bold mb-4">Contacto</h3>
              <p className="mb-4">Contacto con el desarrollador: Agradecemos que adjunto al mensaje nos envíes un método de contacto para poder contactarte.</p>
          ...
          <div className="mt-8 text-center">
            <p>&copy; {new Date().getFullYear()} V-WAD COMPANY. Todos los derechos reservados.</p>
          </div>
        </div>
      </footer>
    </div>
